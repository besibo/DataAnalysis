...
if (requireNamespace("sysfonts", quietly = TRUE) &&
  ...
  sysfonts::font_add(
    family = "Adelle-Light",
    regular = "fonts/Adelle light.otf",
    italic = "fonts/Adelle Light Italic.otf",
    bold = "fonts/Adelle Semi bold.otf",
    bolditalic = "fonts/Adelle Semi Bold Italic.otf"
  )

  gill_sans <- systemfonts::system_fonts() |>
    dplyr::filter(family == "Gill Sans", style == "Regular") |>
    dplyr::slice_head(n = 1)

  if (nrow(gill_sans) > 0) {
    sysfonts::font_add(family = "Gill Sans", regular = gill_sans$path[[1]])
  }
